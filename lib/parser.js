...
var grammar = (function () {
  ...
  var raw = {
    ...
    date_if_then: /^(substitutes )?(?:_date)?(?:_islamic)? if ((?:(?:_weekdays),?)*) then _direction _days(?: if ((?:(?:_weekdays),?)*) then _direction _days)?(?: if ((?:(?:_weekdays),?)*) then _direction _days)?(?: if ((?:(?:_weekdays),?)*) then _direction _days)?/,
