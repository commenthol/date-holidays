export const data = {
  ...
  "holidays": {
          ...
          "regions": {
            "A": {
              "names": {
                "de": "Stadt Augsburg",
                "en": "City of Augsburg",
                "fr": "Ville d'Augsbourg"
              },
              "days": {
                "08-08": {
                  "name": {
                    "de": "Augsburger Friedensfest",
                    "fr": "Festival de la paix d'Augsbourg",
                    "nl": "Augsburgse Hoog Vredesfeest",
            ...
            "EVANG": {
              "names": {
                ...
                "fr": "Communautés majoritairement protestantes"
              },
              "days": {
                "08-15": {
                  "_name": "08-15",
    ...
    "FR": {
      ...
      "states": {
        ...
        "WF": {
          "name": "Département et région d'outre-mer Wallis et Futuna",
          "zones": [
            "Pacific/Wallis"
          ],
          "_days": "WF"
        ...
        "NC": {
          "name": "Département et région d'outre-mer Nouvelle Calédonie",
          "zones": [
            "Pacific/Noumea"
          ],
          "_days": "NC"
        ...
        "PF": {
          "name": "Département et région d'outre-mer Polynésie Française",
          "zones": {
            "zones": [
              "Pacific/Tahiti",
              "Pacific/Marquesas",
      ...
      "days": {
        "03-05": {
          "name": {
            ...
            "de": "Tag der Autonomie",
            "nl": "Dag van de Autonomie",
            "en": "Internal Autonomy Day"
          }
        },
        "06-29": {
          "name": {
            "fr": "Arrivée de l'Evangile",
            "de": "Ankunft des Evangeliums",
            "nl": "Aankomst van het Evangelie",
            "en": "Missionary Day"
          }
        }
      }
      ...
      "days": {
        "07-29": {
          "name": {
            ...
            "de": "Territorialfest",
            "nl": "Territoriumfestival",
            "en": "Festival of the territory"
          }
        },
        "04-28": {
          "name": {
            "fr": "Saint Pierre Chanel",
            "de": "Fest des Heiligen Peter Chanel",
            "nl": "Feest van Sint-Pieter Chanel",
            "en": "Feast of Saint Peter Chanel"
          }
        }
      },
      "states": {
  ...
  "names": {
    ...
    "Buß- und Bettag": {
      "name": {
        "de": "Buß- und Bettag",
        "fr": "Jour de pénitence et de prières",
        "nl": "Boete- en Biddag",
